...
from repositories.ecritures.ecritures_repository import fetch_ecritures, societe_est_cloturee_repository, ecriture_verrouillee_repository`r`nfrom repositories.ecritures.stats_repository import fetch_global_stats`r`nfrom repositories.ecritures.stats_repository import fetch_global_stats
