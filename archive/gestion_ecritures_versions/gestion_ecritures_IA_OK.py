...
def reanalyser_pieces():
    ...
    for piece in pieces:
        ...
        for ligne in lignes_ocr:
            ...
            if "lokki" in ligne_lower and not fournisseur_detecte:
                fournisseur_detecte = "Lokki"
                score_ia += 25

            if "facture" in ligne_lower and not numero_facture_detecte:
                numero_facture_detecte = ligne.strip()
                score_ia += 20
