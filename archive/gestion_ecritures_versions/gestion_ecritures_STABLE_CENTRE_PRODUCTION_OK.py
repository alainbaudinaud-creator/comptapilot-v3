...
def production_centre_controle():
    ...
    <ul>
        <li><a href="/ecritures/production/health">Sante systeme</a></li>
        <li><a href="/ecritures/production/audit">Audit comptable</a></li>
        <li><a href="/ecritures/production/sauvegarde">Creer sauvegarde</a></li>
        <li><a href="/ecritures/dossiers-comptables">Dossiers comptables</a></li>
        <li><a href="/ecritures/dossier/dashboard">Dashboard dossier</a></li>
        <li><a href="/ecritures/export-fec">Export FEC</a></li>
        <li><a href="/ecritures/controle-verrouillage">Controle verrouillage</a></li>
        <li><a href="/ecritures/controle-clotures">Clotures comptables</a></li>
    </ul>
    """
